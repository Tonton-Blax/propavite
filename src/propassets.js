  ...
  return {
    ...
    cheesy: [
      {
        target: ".reverbere",
        xPercent: 300,
        scale: (/** @type {number} */ i) => 1 + i / elementsCheesy,
      },
      {
      ...
      },
      {
        target: ".palmier",
        xPercent: 200,
        scale: (/** @type {number} */ i) => 1 + i / 1.5 / elementsCheesy,
        time: "<",
      },
    ],
    ...
    poetic: [
      ...
      },
      {
        ...
        time: "<",
        duration: 2,
        rotateZ: (/** @type {number} */ i) =>
          100 + (i + 1) * (Math.random() * 360),
        x: (/** @type {number} */ i) => rdTable[i % 1000],
        y: (/** @type {number} */ i) => rdTable[(i + 1) % 1000],
      },
      {
        target: ".poetic",
        x: 0,
        ...
        xPercent: (/** @type {number} */ i) =>
          [0, 1, 3].includes(i) ? -150 * i : 150 * (i + 1),
        scale: (/** @type {number} */ i) => i,
        time: "<+10%",
        stagger: {
          grid: [3, 2],
          from: "center",
    ...
    retrochic: [
      {
        target: ".propa-mask-clip",
        scale: isMobile ? 50 : 20,
        duration: 5,
        ...(isMobile
          ? {
              set: {
                transformOrigin: `${window.innerWidth / 2}px ${window.innerHeight / 2 - 35}px`,
              },
            }
          : {
              set: {
                transformOrigin: `${window.innerWidth / 2 + 550}px ${window.innerHeight / 2}px`,
              },
            }),
        ease: "power1.in",
      },
      ...
      },
      {
        ...
        set: {
          rotate: (/** @type {number} */ i) => -Math.random() * 360 * (i + 1),
        },
        y: (/** @type {number} */ _i) => -window.innerHeight * 1.2,
        duration: 3,
...
export const typographicPaths = [
  ...
  [
    "M83.29,35.63c27.45,0,48.05-14.08,54.54-35.63H30.03c6.41,21.83,26.09,35.63,53.27,35.63Z",
    "M140,49.34H0v7.75H8.09c19.7,.6,25.67,5.37,26.26,20.87v62.04h105.65V49.34Z",
  ],
  [
  ...
  [
    "M72.22,24.1c0-8.43-2.3-16.85-6.57-24.1H0V61.03c7.24,4.66,15.89,7.35,25.24,7.35,26.46,0,46.98-19.44,46.98-44.28Z",
    "M55.48,140v-13.84c1.62-31.86,7.02-42.66,30.24-60.48,2.7-2.16,9.72-8.64,17.28-16.2V119.14c0,7.12-.53,14.13-1.48,20.86h38.47V0h-35.92c0,.11,0,.22,0,.34,0,22.14-4.32,41.58-10.8,50.22-9.18,11.88-32.4,22.68-62.1,28.08-12.26,2.36-22.67,5.23-31.18,8.53v52.83H55.48Z",
  ],
  ...
  [
    "M69.31,140v-60.21h36.82v-5.6h-36.82V21.36c0-9.14,2.1-16.27,6.2-21.36H26.81c-.11,.05-.22,.1-.32,.15C11.85,7.78,3.26,18.67,0,33.86v106.14H69.31Z",
    "M96.43,0c-1.82,1.22-3.36,2.59-4.71,4.16-5.6,6-8.8,14.81-8.8,23.21,0,19.21,15.61,34.02,35.22,34.02,8.41,0,15.92-2.72,21.87-7.37V0h-43.57Z",
  ],
  [
    ...
    retrochic: [
      {
        ...
        startAt: {
          rotate: (/** @type {number} */ i) =>
            Math.min((!(i % 2) ? 1 : -1) * Math.random() * 360, 10),
        },
        rotate: "+=360",
        yoyo: false,
        duration: 35,
